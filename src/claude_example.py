...
url = "https://s22.q4cdn.com/959853165/files/doc_financials/2026/q1/FINAL-Q1-26-Shareholder-Letter.pdf"
...
message = client.messages.create(
    ...
    messages=[
        ...
        {"role": "user", "content": f"You are a real-time trading investor, think hard, do you think stock will go up based on these results and expectations? NFLX earnings report: <report> {earnings_report_content} </report> and earnings expectation guidance: <expectation>{expectation_content}</expectation> would you buy NFLX stock immediately based on these results and expectations? Respond with simple text yes or no and short summary explaining your reasoning."}
    ]
)
